...
public class CedarFieldUtil {
  ...
  public static Map<String, Object> generateDefaultSectionBreak(String sectionName, String description,
                                                                Constants.CedarServer cedarServer) {
    ...
    defaultSectionBreak.put(ModelNodeNames.PAV_LAST_UPDATED_ON, null); // Will be automatically generated when
    // posting it
